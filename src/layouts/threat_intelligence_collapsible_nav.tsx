...
const ThreatIntelligenceLinks: EuiPinnableListGroupItemProps[] = [
  { label: 'Intelligence', href: `${pathPrefix}/threat-intelligence` },
];
      ...
      <EuiFlexItem className="eui-yScroll">
        <EuiCollapsibleNavGroup
          ...
          <EuiPinnableListGroup
            ...
            listItems={alterLinksWithCurrentState(ThreatIntelligenceLinks)}
